...
## Acceptance
- [x] All agent prompts include a "Logging" section with format instructions
- [x] Agents log: step started, step completed, decisions made, files changed
- [x] Log format aligns with AF-8 audit log format
- [x] Tested: spawn engineer and researcher, verify logs are parseable
